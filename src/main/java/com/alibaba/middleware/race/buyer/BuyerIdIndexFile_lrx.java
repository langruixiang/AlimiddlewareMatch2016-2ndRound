 ...
 */
public class BuyerIdIndexFile_lrx extends Thread{
    ...
    public BuyerIdIndexFile_lrx(CountDownLatch hashDownLatch, CountDownLatch buildIndexCountLatch, int index) {
