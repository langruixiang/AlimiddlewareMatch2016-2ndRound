 ...
 */
public class NewBuyerIndexFile extends Thread{
    ...
    public NewBuyerIndexFile(CountDownLatch hashDownLatch, CountDownLatch buildIndexCountLatch, int index) {
    ...
    public void generateBuyerIndex() {
            ...
            try {
                ...
                while ((line = buyer_br.readLine()) != null) {
                    int buyerIdStartIndex = line.indexOf("buyerid:") + 8;// 8 : "buyerid:".length()
                    ...
                    NewOneIndexCache.buyerOneIndexCache.put(buyerId, new PosInfo(offset, length));
