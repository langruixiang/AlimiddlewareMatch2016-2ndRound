 ...
 */
public class NewOrderIdIndexFile extends Thread{
    ...
    public NewOrderIdIndexFile(CountDownLatch hashDownLatch, CountDownLatch buildIndexCountLatch, int concurrentNum) {
