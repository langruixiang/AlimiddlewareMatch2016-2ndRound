 ...
 *
 */
public class NewGoodIdHashHandler extends StringEventHandler implements Runnable {
    ...
    public NewGoodIdHashHandler(int handlerId, int hashFileNum, BufferedWriter[] bufferedWriters, int writeThreadNum, CountDownLatch latch) {
        super(handlerId);
